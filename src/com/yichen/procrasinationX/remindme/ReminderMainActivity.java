package com.yichen.procrasinationX.remindme;
...
import com.yichen.procrasinationX.remindme.model.Alarm;
import com.yichen.procrasinationX.remindme.model.AlarmMsg;

public class ReminderMainActivity extends ListActivity {
		
//		private static final String TAG = "ReminderMainActicity";
		
		private TextView headingText;
		private TextView rangeText;
//		private ViewSwitcher vs;
		//private RemindMe RemindMe1;
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.remindermain);//need...change
			...
			adapter.setViewBinder(new ViewBinder() {
				...
				public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
					...
					case R.id.time_tv:
						...
						String txt = SmartPad.showRemainingTime() ? Util.getRemainingTime(time, now) : Util.getActualTime(dt.getHours(), dt.getMinutes());
			       ...
			       .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
			           public void onClick(DialogInterface dialog, int id) {
			        	   ...
			        	   if (!TextUtils.isEmpty(msgEdit.getText())) {
			        		   ...
			        		   Toast.makeText(ReminderMainActivity.this, "Enter a message", Toast.LENGTH_SHORT).show();
			        	   }
			           }
			       })
